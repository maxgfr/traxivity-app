...
public class ActivityManager {
    ...
    public void insertActivity(DbActivity myActivity) {
     ...
     ArrayList<DbActivity> getDay(final String wantedDate){
         listActivity.clear();
    ...
    ArrayList<DbActivity> getRangeDay(final String startDate, final String endDate) throws ParseException {
        listActivity.clear();
        ...
        final List<String> resultDates = new ArrayList<>();
